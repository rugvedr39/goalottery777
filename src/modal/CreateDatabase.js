...
const CreateWingo = async(req, res) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        await connection.execute(sql, ['2023110810000', arr[i], timeNow]);
        const sql_1 = "INSERT INTO wingo SET period = ?, game = ?, amount = 0, status = 0, time = ?";
        await connection.execute(sql_1, ['2023110810001', arr[i], timeNow]);
    }
...
const Create5D = async(req, res) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        await connection.execute(sql, ['2023110810000', '23521', arr[i], timeNow]);
        const sql_1 = "INSERT INTO 5d SET period = ?, result = ?, game = ?, status = 0, time = ?";
        await connection.execute(sql_1, ['2023110810001', '0', arr[i], timeNow]);
    }
...
const CreateK3 = async(req, res) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        await connection.execute(sql, ['2023110810000', '235', arr[i], timeNow]);
...
const Level = async(req, res) => {
    ...
    await connection.execute("INSERT INTO level SET id = 7, level = 6, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 6, level = 5, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 5, level = 4, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 4, level = 3, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 3, level = 2, f1 =0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 2, level = 1, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
    await connection.execute("INSERT INTO level SET id = 1, level = 0, f1 = 0, f2 = 0, f3 = 0, f4 = 0");
}
...
const Admin = async(req, res) => {
    ...
    await connection.execute("INSERT INTO `admin` (`id`, `wingo1`, `wingo3`, `wingo5`, `wingo10`, `k5d`, `k5d3`, `k5d5`, `k5d10`, `win_rate`, `telegram`, `cskh`, `app`) VALUES (NULL, '-1', '-1', '-1', '-1', '-1', '-1', '-1', '-1', '-1', 'https://t.me/selfhealerbot', 'https://t.me/selfhealerbot', '#')");
}
