...
$(`.game-betting .box .item .img .van-image img`).attr('src', '/assets/png/time-5d4e96a3.png');
$(`.game-betting .box .item:eq(${selectPageTime - 1}) .img .van-image img`).attr('src', '/assets/png/time_a-f83ed4c71.png');