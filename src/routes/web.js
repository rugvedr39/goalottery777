...
const initWebRouter = (app) => {
    ...
    router.get('/superjackpot', middlewareController, homeController.superjackpot);
    router.get('/inviterule', middlewareController, homeController.inviterule);
    ...
    router.get('/wallet/recharge/pay2', middlewareController, homeController.rechargeGateway2);
    router.get('/wallet/recharge/pay3', middlewareController, homeController.rechargeGateway3);
    router.get('/wallet/recharge/pay4', middlewareController, homeController.rechargeGateway4);
    router.get('/wallet/withdrawal', middlewareController, homeController.withdrawalPage);
    router.get('/wallet/rechargerecord', middlewareController, homeController.rechargerecordPage);
    router.get('/wallet/withdrawalrecord', middlewareController, homeController.withdrawalrecordPage);
    router.get('/wallet/addBank', middlewareController, homeController.addBank);
